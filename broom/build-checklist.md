...
- [ ] **Mount the 11 SRx4 boards**, one per 2×4. Mount **A, B & F** receivers (A & B on the 2nd-floor railings / old Angio magnet spots; **F1** is the new back-left board on **port 11**)
...
- [ ] **Hang zone A** (L01–L28), the **zone B** remainder, and the **new zone F** (F01–F12, 12 new tubes, back-left / left of the ladder) — C, D, E already hung & powered
...
- [ ] Note the **as-built swap**: B2 (`L43–L56`) hangs back-right, D1 (`R01–R14`) back-left (data/channels unchanged)
...
- [ ] **Trunk legs (2026-08):** Leg 1 (joins at **B1**) → A1, A2, B1, B2, C1 · Leg 2 (joins at **D2**) → C2, D1, D2, E1, E2, F1. ⚠️ B2 & D1 are physically swapped, so their drops cross the back — [led-wiring.md](../electrical/led-wiring.md)
